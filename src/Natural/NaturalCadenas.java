...
public class NaturalCadenas {
    ...
    public void proceso(String nombreArchivo) throws Exception {
        ...
        File aux1 = new File("Natural/Cadenas/aux_1.csv");
        File aux2 = new File("Natural/Cadenas/aux_2.cvs");
    ...
    private boolean division(File F, File F1, File F2) throws IOException {
        ...
        while (archivo.readRecord()) {
        	...
        	//Obtengo la segunda columna
            actual = archivo.get(1);
            
            if (anterior == null) {
                anterior = actual;
            }
            //Condicion de evaluacion de cadenas 
